...
New contributors should start with `docs/HANDOFF.md`. The end-to-end production sequence and launch gates live in `docs/PRODUCTION_PLAN.md`, and deployment/backup/rollback procedures live in `docs/OPERATIONS.md`. Project tracking continues in `docs/PROJECT_STATUS.md`, `docs/ROADMAP.md`, `docs/TASKS.md`, `docs/CHANGELOG.md`, `docs/DECISIONS.md`, `docs/BUGS.md`, and `docs/DEPLOYMENT_LOG.md`.
